...
config.General.requestName       = 'FourGammasGunPt1-100_DeepSC_algoB_bugFix'
...
config.JobType.psetName          = 'RecoSimDumper_fromRAW_DeepSC_algoB_cfg.py'
...
config.Data.outputDatasetTag     = 'Dumper_UL18_pfRechitThres_DeepSC_algoB_bugFix'
