...
from RecoSimStudies.Dumpers.customize_recodumper import customize_mustache_noise235fb_thres235fb,customize_baselineMC,customize_dumperStepMC,customize_linkedObjectsStep 

#call to customisation function customize_mustache_noise235fb_thres235fb imported from RecoSimStudies.Dumpers.customize_recodumper
process = customize_mustache_noise235fb_thres235fb(process)
