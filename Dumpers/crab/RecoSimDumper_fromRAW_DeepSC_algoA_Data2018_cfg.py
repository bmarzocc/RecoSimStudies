...
# with command line options: -s RAW2DIGI,L1Reco,RECO,PAT --conditions 123X_dataRun2_v4 --data --era Run2_2018 --python_filename=RecoSimDumper_fromRAW_DeepSC_algoA_Data2018_cfg.py --filein=/store/data/Run2022D/EGamma/RAW-RECO/ZElectron-PromptReco-v2/000/357/734/00000/0002e651-145c-4b78-8746-41629601d33f.root --procModifier ecal_deepsc
...
process = cms.Process('ECALClustering',Run2_2018,ecal_deepsc)
...
process.RECOSIMoutput.outputCommands.extend(['keep *'])
