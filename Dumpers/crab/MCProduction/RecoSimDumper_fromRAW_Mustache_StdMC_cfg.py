...
# with command line options: --python_filename RecoSimDumper_fromRAW_Mustache_StdMC_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:step3.root --conditions 126X_mcRun3_2023_forPU65_v4 --step RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --geometry DB:Extended --filein root://cms-xrd-global.cern.ch//store/group/dpg_ecal/Clustering/FourElectronsGunPt1-500_pythia8_PremixRun3_13p6TeV_126X_mcRun3_2023_forPU65_v4/GEN-SIM-RAW-CALO/230830_172305/0000/output_100.root --era Run3_2023 --no_exec --mc --customise RecoParticleFlow/PFClusterProducer/particleFlow_HB2023.customiseHB2023,Configuration/DataProcessing/Utils.addMonitoring,RecoSimStudies/Dumpers/customize_recodumper.customize_baselineMC,RecoSimStudies/Dumpers/customize_recodumper.customize_dumperStepMC,RecoSimStudies/Dumpers/customize_recodumper.customize_linkedObjectsStep --processName ECALClustering -n 10 --nThreads 4
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2023_cff import Run3_2023

process = cms.Process('ECALClustering',Run3_2023)
...
from RecoSimStudies.Dumpers.customize_recodumper import customize_baselineMC,customize_dumperStepMC,customize_linkedObjectsStep 
