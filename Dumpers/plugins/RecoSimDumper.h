...
class RecoSimDumper : public edm::one::EDAnalyzer<edm::one::SharedResources>
{
	 ...
	 void analyze(const edm::Event&, const edm::EventSetup&) override;
      ...
      std::vector<int> gsfElectron_scNPFClusters;
      ...
      std::vector<float> gsfElectron_scEnergy;
      std::vector<float> gsfElectron_scRawEnergy;
      std::vector<float> gsfElectron_scRawESEnergy;
      std::vector<float> gsfElectron_scEt;
      std::vector<float> gsfElectron_scPhiWidth;
      std::vector<float> gsfElectron_scEtaWidth;
      std::vector<float> gsfElectron_scEoP;
      ...
      std::vector<float> gsfElectron_ecalSCEta;
      std::vector<float> gsfElectron_ecalSCPhi;
      ...
      std::vector<int> gedPhoton_scNPFClusters;
      ...
      std::vector<float> gedPhoton_scEnergy;  
      std::vector<float> gedPhoton_scRawEnergy;  
      std::vector<float> gedPhoton_scRawESEnergy;
      std::vector<float> gedPhoton_scEt;
      std::vector<float> gedPhoton_scEtaWidth;
      std::vector<float> gedPhoton_scPhiWidth; 
      ...
      std::vector<float> gedPhoton_ecalSCEta;
      std::vector<float> gedPhoton_ecalSCPhi; 
      ...
      std::vector<float> patElectron_ecalSCEta;
      std::vector<float> patElectron_ecalSCPhi;
      ...
      std::vector<float> patPhoton_ecalSCEta;
      std::vector<float> patPhoton_ecalSCPhi;
      ...
      std::vector<int> genMotherIndices; 
