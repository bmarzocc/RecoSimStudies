...
class RecoSimDumper : public edm::one::EDAnalyzer<edm::one::SharedResources>
{
	 ...
	 void analyze(const edm::Event&, const edm::EventSetup&) override;
      ...
      std::vector<int> gsfElectron_isEB;
      std::vector<int> gsfElectron_isEE;
      std::vector<int> gsfElectron_classification;
      std::vector<int> gsfElectron_nPFClusters;
      ...
      std::vector<float> gsfElectron_refinedSCSwissCross;
      std::vector<float> gsfElectron_refinedSCEtaWidth;
      std::vector<float> gsfElectron_refinedSCPhiWidth; 
      std::vector<float> gsfElectron_refinedSCEMax;
      std::vector<float> gsfElectron_refinedSCE2x2;
      std::vector<float> gsfElectron_refinedSCE3x3;
      std::vector<float> gsfElectron_refinedSCE5x5;
      std::vector<float> gsfElectron_refinedSCR9; 
      std::vector<float> gsfElectron_refinedSCSigmaIEtaIEta;
      std::vector<float> gsfElectron_refinedSCSigmaIEtaIPhi;
      std::vector<float> gsfElectron_refinedSCSigmaIPhiIPhi; 
      std::vector<float> gsfElectron_full5x5_refinedSCEMax;
      std::vector<float> gsfElectron_full5x5_refinedSCE2x2;
      std::vector<float> gsfElectron_full5x5_refinedSCE3x3;
      std::vector<float> gsfElectron_full5x5_refinedSCE5x5;
      std::vector<float> gsfElectron_full5x5_refinedSCR9; 
      std::vector<float> gsfElectron_full5x5_refinedSCSigmaIEtaIEta;
      ...
      std::vector<int> gedPhoton_isEE;
      std::vector<int> gedPhoton_nPFClusters;
      ...
      std::vector<float> gedPhoton_refinedSCSwissCross;
      std::vector<float> gedPhoton_refinedSCEMax;
      std::vector<float> gedPhoton_refinedSCE2x2;
      std::vector<float> gedPhoton_refinedSCE3x3;
      std::vector<float> gedPhoton_refinedSCE5x5;
      std::vector<float> gedPhoton_refinedSCR9;
      std::vector<float> gedPhoton_refinedSCSigmaIEtaIEta;
      std::vector<float> gedPhoton_refinedSCSigmaIEtaIPhi;
      std::vector<float> gedPhoton_refinedSCSigmaIPhiIPhi; 
      std::vector<float> gedPhoton_full5x5_refinedSCEMax;
      std::vector<float> gedPhoton_full5x5_refinedSCE2x2;
      std::vector<float> gedPhoton_full5x5_refinedSCE3x3;
      std::vector<float> gedPhoton_full5x5_refinedSCE5x5;
      std::vector<float> gedPhoton_full5x5_refinedSCR9;
      std::vector<float> gedPhoton_full5x5_refinedSCSigmaIEtaIEta;
      ...
      std::vector<int> patElectron_nPFClusters;
      ...
      std::vector<float> patElectron_refinedSCEta;
      std::vector<float> patElectron_refinedSCPhi;
      std::vector<float> patElectron_refinedSCEnergy;
      std::vector<float> patElectron_refinedSCRawEnergy;
      std::vector<float> patElectron_refinedSCESEnergy;
      ...
      std::vector<float> patElectron_refinedSCSwissCross;
      std::vector<float> patElectron_refinedSCE2x2;
      std::vector<float> patElectron_refinedSCE3x3; 
      std::vector<float> patElectron_refinedSCE5x5; 
      std::vector<float> patElectron_refinedSCEMax;
      std::vector<float> patElectron_refinedSCR9; 
      std::vector<float> patElectron_refinedSCSigmaIEtaIEta;
      std::vector<float> patElectron_refinedSCSigmaIEtaIPhi;
      std::vector<float> patElectron_refinedSCSigmaIPhiIPhi;
      std::vector<float> patElectron_full5x5_refinedSCE2x2;
      std::vector<float> patElectron_full5x5_refinedSCE3x3;
      std::vector<float> patElectron_full5x5_refinedSCE5x5;
      std::vector<float> patElectron_full5x5_refinedSCEMax;
      std::vector<float> patElectron_full5x5_refinedSCR9;  
      std::vector<float> patElectron_full5x5_refinedSCSigmaIEtaIEta;
      ...
      std::vector<int> patPhoton_nPFClusters;
      ...
      std::vector<float> patPhoton_refinedSCEta;
      std::vector<float> patPhoton_refinedSCPhi;
      std::vector<float> patPhoton_refinedSCEnergy;
      std::vector<float> patPhoton_refinedSCRawEnergy;
      std::vector<float> patPhoton_refinedSCESEnergy;
      ...
      std::vector<float> patPhoton_refinedSCSwissCross;
      std::vector<float> patPhoton_refinedSCE2x2;
      std::vector<float> patPhoton_refinedSCE3x3; 
      std::vector<float> patPhoton_refinedSCE5x5; 
      std::vector<float> patPhoton_refinedSCEMax;
      std::vector<float> patPhoton_refinedSCR9;
      std::vector<float> patPhoton_refinedSCSigmaIEtaIEta;
      std::vector<float> patPhoton_refinedSCSigmaIEtaIPhi;
      std::vector<float> patPhoton_refinedSCSigmaIPhiIPhi;
      std::vector<float> patPhoton_full5x5_refinedSCE2x2;
      std::vector<float> patPhoton_full5x5_refinedSCE3x3;
      std::vector<float> patPhoton_full5x5_refinedSCE5x5;
      std::vector<float> patPhoton_full5x5_refinedSCEMax;
      std::vector<float> patPhoton_full5x5_refinedSCR9;
      std::vector<float> patPhoton_full5x5_refinedSCSigmaIEtaIEta;
