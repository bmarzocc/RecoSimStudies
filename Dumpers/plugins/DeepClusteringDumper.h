#ifndef RecoSimStudies_Dumpers_DeepClusteringDumper_H
#define RecoSimStudies_Dumpers_DeepClusteringDumper_H
...
class DeepClusteringDumper : public edm::EDAnalyzer
{
      public:
         explicit DeepClusteringDumper(const edm::ParameterSet&);
	 ~DeepClusteringDumper();
