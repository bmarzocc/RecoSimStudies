...
recosimdumper = cms.EDAnalyzer("RecoSimDumper",
    ...
    patElectronCollection           = cms.InputTag("linkedObjects","electrons","ECALClustering"), 
    patPhotonCollection             = cms.InputTag("linkedObjects","photons","ECALClustering"), 
    patJetCollection                = cms.InputTag("linkedObjects","jets","ECALClustering"), 
    ...
    savePatPhotons                  = cms.bool(False),  #save patPhotons and patMET information
    savePatElectrons                = cms.bool(False),  #save patElectrons and patMET information
    savePatJets                     = cms.bool(False),  #save patJets and patMET information
    ...
    jmeCutBasedPFJetIDloose         = cms.vstring('LEGACY16','CHS','LOOSE'),  #CutBasedPFJetID loose (version, algo, quality), USE ONLY FOR RERECO-2016 Data/MC   
    jmeCutBasedPFJetIDtight         = cms.vstring('UL18','CHS','TIGHT'),  #CutBasedPFJetID tight  (version, algo, quality)   
    jmeCutBasedPFJetIDtightLepVeto  = cms.vstring('UL18','CHS','TIGHTLEPVETO'),  #CutBasedPFJetID tightLepVeto  (version, algo, quality)     
)
