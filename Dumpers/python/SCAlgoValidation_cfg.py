...
process.histOpt = cms.PSet(
    ...
    EoEtrueBins_Barrel = cms.vdouble(100,0.8,1.2), 
    EoEtrueBins_Endcap = cms.vdouble(100,0.8,1.5), 
    EoEgenBins_Barrel = cms.vdouble(100,0.8,1.2), 
    EoEgenBins_Endcap = cms.vdouble(100,0.8,1.5),  
    ...
    SigmaIetaIphiBins_Barrel = cms.vdouble(200,0.,0.001),
    SigmaIetaIphiBins_Endcap = cms.vdouble(400,0.,0.005), 
    full5x5_SigmaIetaIphiBins_Barrel = cms.vdouble(200,0.,0.001),
    full5x5_SigmaIetaIphiBins_Endcap = cms.vdouble(400,0.,0.005), 
